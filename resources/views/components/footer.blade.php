<footer class="bg-[#e5e5e5] px-6 md:px-16 py-16">
  
  <div class="grid grid-cols-1 md:grid-cols-4 gap-12 ">
 
    <div>
      <img  class="h-8 inline-block mr-2" src="{{ asset('images/FeedGo.png') }}" alt="">
      <p class="text-sm text-gray-700 leading-relaxed max-w-sm mb-6">
      ...
      <div class="flex gap-3">
        <a href="#" class="w-9 h-9 bg-white rounded-full flex items-center justify-center shadow text-gray-700"><svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
        ...
        <a href="#" class="w-9 h-9 bg-white rounded-full flex items-center justify-center shadow text-gray-700"><svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
