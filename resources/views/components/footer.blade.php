<footer class="px-6 md:px-16 py-16 mt-16">
  ...
  <div class="flex justify-between">
    <div class="flex gap-3">
      <a href="#" class="w-9 h-9 bg-white rounded-full flex items-center justify-center shadow text-gray-700 shadow-xl"><svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
      ...
      <a href="#" class="w-9 h-9 bg-white rounded-full flex items-center justify-center shadow text-gray-700 shadow-xl"><svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    ...
    <div>
      <div class="flex items-center rounded-full border-3 border-[#D9D9D9]">
        <input
          ...
          class="bg-transparent text-sm outline-none flex-1 py-2 px-7 "
        >
